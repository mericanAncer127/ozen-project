...
import {menuData, contact} from './UIData';
								...
								<ul className="navbar-nav m-auto">
                                    {
                                        ...
                                        <li className="nav-item" key={menu.title}>
                                            <Link href={menu.link} activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    {menu.title}
                                                </a>
                                            </Link>
                                            {menu.subtitle.length ? <ul className="dropdown-menu">
                                                {menu.subtitle.map((smenu) => 
                                                    <li className="nav-item" key={smenu.title}>
                                                        <Link
                                                            href={smenu.link}
                                                        ...
                                                        {
                                                            smenu.subtitle.length ? 
                                                            <ul className="dropdown-menu">
                                                                {
                                                                    smenu.subtitle.map((ssmenu)=>
                                                                    <li className="nav-item" key={ssmenu.title}>
                                                                        <Link href={ssmenu.link} activeClassName="active">
                                                                            <a onClick={toggleNavbar} className="nav-link">
                                                                                {ssmenu.title}
                                                                            </a>
                                                                        </Link>
